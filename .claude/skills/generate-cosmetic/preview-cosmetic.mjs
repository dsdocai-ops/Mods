...
//
// TEXTURED cosmetics (a real PNG on CosmeticTexturedMesh's cloth-like strips, CAPE only for now -
// see that class's doc): --id resolves a catalog cosmetic's own texture from the Fabric resource
