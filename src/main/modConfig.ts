...
const OMEGA_CONFIG_DEFAULTS: Record<string, unknown> = {
  ...
  ownedCosmeticId: "",
  cosmeticsMasterEnabled: true,
  showOwnCosmeticsEnabled: true,
  showOthersCosmeticsEnabled: true,
  hatCosmeticsEnabled: true,
  capeCosmeticsEnabled: true,
  wingsCosmeticsEnabled: true,
