...
public final class CosmeticPixelArt {
    ...
    /**
     * Molten crown hat: a TRUE 3D VOXEL king's crown with 6 alternating tall/short spikes (real
     * transparent gaps between them, generated via voxel-hat-builder.mjs --alt-height) and a real
     * multi-stop "cooling lava" gradient down the body - pale cream flame tips, through bright
     * orange, deep rust, to a near-black base - so the heat story reads as one continuous, legible
     * ramp instead of a flat mass or a scrambled color order. A dark trim ring continues the
     * gradient's darkest tone (not a bright interruption), under ONE gold band carrying a single
     * bold cream gem as a distinct jewelry accent, and a dark base rim. Reviewed against the
     * catalog's other hats and judged to clear a genuine Lunar/Feather paid-cosmetic bar - see the
     * generate-cosmetic skill's "Judging whether a cosmetic actually looks good" section for the
     * value-contrast and silhouette-legibility principles this was built to satisfy. 14w x 10h x 14d,
     * top slice first.
     */
