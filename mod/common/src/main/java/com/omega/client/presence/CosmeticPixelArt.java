...
public final class CosmeticPixelArt {
    ...
    /**
     * Molten crown hat: a jagged basalt crown as TRUE 3D VOXEL art - a four-point rock peak, tapering
     * crack-veined walls widening into a full glowing molten band, a dark ember-rim disc, and a
     * bordered stone brim, with a broken gold chain running down both sides of the shell into a pair
     * of dangling ember charms below the brim. 14w x 10h x 14d, top slice first.
     */
