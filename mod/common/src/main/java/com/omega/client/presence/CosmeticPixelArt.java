...
public final class CosmeticPixelArt {
    ...
    /**
     * Molten crown hat: a jagged 8-point crown as TRUE 3D VOXEL art - a cream-gold-tipped peak
     * over a glowing ember-red-orange band veined with brighter molten cracks, a gold browband set
     * with four ruby gems at the cardinal points, and a dark maroon base rim. Body color is a
     * deliberately mid-toned ember red-orange (not near-black obsidian) so the renderer's flat
     * 1.0/0.65/0.5 top/side/bottom face shading actually reads as a lit 3D shape instead of one
     * flat dark mass - see the generate-cosmetic skill's "Judging whether a cosmetic actually looks
     * good" section. 14w x 8h x 14d, top slice first.
     */
