...
const KNOWN_COSMETIC_IDS = ["gold_badge", "azure_badge", "crimson_cape", "nightfall_cape", "seraph_wings", "obsidian_top_hat", "navy_captain_hat", "starlit_cape", "eclipse_cape", "inferno_wings", "azure_charm_hat", "twilight_summit_cape", "checkered_bucket_hat"];
